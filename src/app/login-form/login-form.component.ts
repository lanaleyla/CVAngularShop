...
export class LoginFormComponent implements OnInit {
  ...
  constructor(fb: FormBuilder, private pageService: PageService,private userService:UserService) {
  ...
  resetForm() {
    ...
    if (user) {
      this.pageService.currentPage = this.pageService.previousPage;  //update page, go back
      this.userFound = true;
